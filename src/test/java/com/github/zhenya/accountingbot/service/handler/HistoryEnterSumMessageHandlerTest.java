...
import static com.github.zhenya.accountingbot.constant.Status.ENTER_COMMENT;
...
class HistoryEnterSumMessageHandlerTest {
    ...
    void handleMessageRequest_expectSuccess() {
        ...
        assertEquals(ENTER_COMMENT, statusCaptor.getValue());
    }

    @Test
    void handleMessageRequest_invalidValueWasPassed() {
        handler.handleMessageRequest("sxczx", 123456L);
